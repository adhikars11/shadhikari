...
- **Trade-offs:** In a U.S. calibration, welfare gains arise only when the environmental externality parameter $\psi > 1.2$ (vs. a benchmark of 0.4), corresponding to a 4.3% consumption-equivalent gain threshold.
